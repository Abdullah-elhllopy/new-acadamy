...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      <Hero>
        <TitleContainer title={isArabic ? 'اتصل بنا' : 'Contact Us'} subtitle={isArabic ? 'نحن هنا للإجابة على استفساراتك ومساعدتك' : 'We are here to answer your questions and help you'} /> 
      </Hero>
      <ContentLayout>
          ...
          <div>
            ...
            <Form methods={methods} onSubmit={methods.handleSubmit(handleSubmit)} className="space-y-4">
              ...
              <FormField
                ...
                required
              />
              <Button type="submit" disabled={loading || createMessage.isPending} className="w-full">
                {loading || createMessage.isPending ? (isArabic ? 'جاري الإرسال...' : 'Sending...') : (isArabic ? 'إرسال' : 'Send')}
              </Button>
            </Form>
          </div>
