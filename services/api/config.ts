...
export const endpoints = {
  ...
  articles: {
    getAll: '/api/Article/All-Articles',
    getById: (id: string) => `/api/Article/get-Article/${id}`,
    getByCategory: (categoryId: string) => `/api/Article/Filter-Articles?categoryId=${categoryId}`,
    search: (query: string) => `/api/Article/Filter-Articles?search=${query}`,
    create: '/api/Article/Create-Article',
    update: '/api/Article/Update-Article',
    delete: (id: string) => `/api/Article/Delete-Article/${id}`,
    comments: {
      getByArticleId: (articleId: string) => `/api/Article/${articleId}/Comments`,
      create: (articleId: string) => `/api/Article/${articleId}/Comments`,
      delete: (articleId: string, commentId: string) => `/api/Article/${articleId}/Comments/${commentId}`,
    },
    rating: {
      getByArticleId: (articleId: string) => `/api/Article/${articleId}/Rating`,
      rate: (articleId: string) => `/api/Article/${articleId}/Rate`,
    },
  },
  articleCategories: {
    getAll: '/api/Article-Category/All-Categories',
    getById: (id: string) => `/api/Article-Category/get-Category/${id}`,
    create: '/api/Article-Category/Create-Category',
    update: '/api/Article-Category/Update-Category',
    delete: (id: string) => `/api/Article-Category/Delete-Category/${id}`,
  },
  caseStudies: {
    getAll: '/api/CaseStudy/All-Case-Studies',
    getById: (id: string) => `/api/CaseStudy/get-Case-Study/${id}`,
    getByIndustry: (industry: string) => `/api/CaseStudy/Filter-Case-Studies?industry=${industry}`,
    create: '/api/CaseStudy/Create-Case-Study',
    update: '/api/CaseStudy/Update-Case-Study',
    delete: (id: string) => `/api/CaseStudy/Delete-Case-Study/${id}`,
  },
  courses: {
